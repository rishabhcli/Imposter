...
| Skill | When to Load |
|-------|--------------|
| `.claude/skills/liquid-glass/` | Implementing UI with .glassEffect, LGCard, LGButton |
| `.claude/skills/swiftui-ios26/` | Using new iOS 26 SwiftUI APIs, Observation |
| `.claude/skills/foundation-models/` | ImagePlayground, SystemLanguageModel integration |
| `.claude/skills/game-logic/` | Reducer patterns, state machine, scoring |
| `.claude/skills/accessibility/` | VoiceOver, Dynamic Type, localization |
